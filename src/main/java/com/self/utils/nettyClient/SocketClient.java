...
public class SocketClient {
	 public static void main(String[] args) throws InterruptedException {
		  //String sendMsg = "7E06012184015A01";
		  //byte[] bytes =  toByteArray(sendMsg);
		  
		  System.out.print(sendMessge("7E06012184015A01"));
		  //Thread.sleep(4);
		  //System.out.print(sendMessge("7E06012184015A01"));
	    }
	 
	    public static String sendMessge(String message) {
	    	String returnstr = "";
	                ...
	                public void run() {
	                    try {
	                        ...
	                        synchronized (callbackService) {
	                            ...
	                            buffer.writeBytes(StringUtil.toByteArray(message));
...
//	                            String returnstr = new String(body);
//	                            
